...
import dev.IncanusGames.LineWarsRevamp.AssetManager.EnumTypes.InputSource;
...
public class UnitAssembler extends Assembler{
	...
	public int createHumanMountedKnight(int posX, int posY, boolean Direction, InputSource input) {
		int entityID = Assembler.E.createEntity();
		//Stats
