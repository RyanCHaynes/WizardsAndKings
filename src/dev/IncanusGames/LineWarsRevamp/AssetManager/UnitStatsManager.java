...
public class UnitStatsManager {
	...
	public static void init(){
		...
		StatsData.get(Factions.HUMAN).get(HumanUnits.FOOT_KNIGHT.ordinal()).setData(10, 0, 1, 0, 0, Factions.HUMAN, "footKnight");
		...
		StatsData.get(Factions.ORC).get(OrcUnits.WOLF.ordinal()).setData(10, 0, 1, 0, 0, Factions.ORC, "Wolf");
	}
}
