...
public class UnitStatsManager {
	...
	public static void init(){
		...
		StatsData.get(Factions.HUMAN).get(HumanUnits.FOOT_KNIGHT.ordinal()).setData(10, 0, .5, 128/8, 0, 0, Factions.HUMAN, "footKnight");
		...
		StatsData.get(Factions.ORC).get(OrcUnits.WOLF.ordinal()).setData(10, 0, .5, 56/2, 0.0, 0, Factions.ORC, "Wolf");
		...
		StatsData.get(Factions.PROPS).get(PropTypes.CLOUDONE.ordinal()).setData(10, 0, .09, 0, 0.0, 0, Factions.PROPS, "Cloud1");
	}
}
